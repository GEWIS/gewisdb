...
final class Version20241020224949 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE BoardMember_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE Keyholder_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE Organ_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE OrganMember_id_seq CASCADE');
        $this->addSql('ALTER TABLE Address DROP CONSTRAINT FK_C2F3561DD665E01D');
        $this->addSql('ALTER TABLE BoardMember DROP CONSTRAINT FK_D9517B2ED665E01D');
        $this->addSql('ALTER TABLE BoardMember DROP CONSTRAINT FK_D9517B2EEFBA85FF292FAD512F37B76A76CE1878B79BB36');
        $this->addSql('ALTER TABLE Decision DROP CONSTRAINT FK_7DDADC1E602FAFFB96F82E16');
        $this->addSql('ALTER TABLE Keyholder DROP CONSTRAINT FK_3C5F7B4DD665E01D');
        $this->addSql('ALTER TABLE Keyholder DROP CONSTRAINT FK_3C5F7B4DEFBA85FF292FAD512F37B76A76CE1878B79BB36');
        ...
        $this->addSql('ALTER TABLE Organ DROP CONSTRAINT FK_46C39B8EEFBA85FF292FAD512F37B76A76CE1878B79BB36');
        ...
        $this->addSql('ALTER TABLE OrganMember DROP CONSTRAINT FK_E5CB2C7DE4445171');
        $this->addSql('ALTER TABLE OrganMember DROP CONSTRAINT FK_E5CB2C7DD665E01D');
        $this->addSql('ALTER TABLE OrganMember DROP CONSTRAINT FK_E5CB2C7DEFBA85FF292FAD512F37B76A76CE1878B79BB36');
