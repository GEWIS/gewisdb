...
final class Version20241020224949 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE ActionLink_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE ApiPrincipal_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE AuditEntry_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE CheckoutSession_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE ConfigItem_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE InstallationFunction_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE Member_lidnr_seq CASCADE');
        $this->addSql('DROP SEQUENCE ProspectiveMember_lidnr_seq CASCADE');
        $this->addSql('DROP SEQUENCE SavedQuery_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE users_id_seq CASCADE');
        $this->addSql('ALTER TABLE ActionLink DROP CONSTRAINT FK_A952B2A5740EE3E7');
        $this->addSql('ALTER TABLE ActionLink DROP CONSTRAINT FK_A952B2A570E4FA78');
        $this->addSql('ALTER TABLE Address DROP CONSTRAINT FK_C2F3561DD665E01D');
        $this->addSql('ALTER TABLE AuditEntry DROP CONSTRAINT FK_DE382FBBA76ED395');
        $this->addSql('ALTER TABLE AuditEntry DROP CONSTRAINT FK_DE382FBB70E4FA78');
        $this->addSql('ALTER TABLE CheckoutSession DROP CONSTRAINT FK_BC63300E740EE3E7');
        $this->addSql('ALTER TABLE CheckoutSession DROP CONSTRAINT FK_BC63300EE03E402D');
        $this->addSql('ALTER TABLE Decision DROP CONSTRAINT FK_7DDADC1E602FAFFB96F82E16');
        ...
        $this->addSql('ALTER TABLE SubDecision DROP CONSTRAINT FK_F0D6EE40602FAFFB96F82E1690E0342DEF6BE237');
        $this->addSql('ALTER TABLE SubDecision DROP CONSTRAINT FK_F0D6EE40D665E01D');
        $this->addSql('ALTER TABLE SubDecision DROP CONSTRAINT FK_F0D6EE40EFBA85FF292FAD512F37B76A76CE1878B79BB36');
        $this->addSql('ALTER TABLE SubDecision DROP CONSTRAINT FK_F0D6EE40EFBA85FF292FAD512F37B76A76CE187');
        $this->addSql('ALTER TABLE SubDecision DROP CONSTRAINT FK_F0D6EE40EFBA85FF292FAD51');
        $this->addSql('DROP TABLE ActionLink');
        $this->addSql('DROP TABLE Address');
        $this->addSql('DROP TABLE ApiPrincipal');
        $this->addSql('DROP TABLE AuditEntry');
        $this->addSql('DROP TABLE CheckoutSession');
        $this->addSql('DROP TABLE ConfigItem');
        ...
        $this->addSql('DROP TABLE ProspectiveMember');
