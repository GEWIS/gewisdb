...
final class Version20250621133119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO MailingListMember (member, email, mailingList) (SELECT m.lidnr as member, m.email as email, "name" as mailingList FROM members_mailinglists as mm LEFT JOIN member as m on m.lidnr = mm.lidnr)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO members_mailinglists (lidnr, name) (SELECT member as lidnr, mailingList as name from MailingListMember)');
