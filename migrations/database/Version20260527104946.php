 ...
 */
final class Version20260527104946 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE ListmonkMailingList (id INT NOT NULL, name VARCHAR(255) NOT NULL, lastSeen TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, lastCheck TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('ALTER TABLE mailinglist ADD listmonkId INT DEFAULT NULL');
