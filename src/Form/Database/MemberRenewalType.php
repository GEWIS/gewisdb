...
class MemberRenewalType extends AbstractType
{
    ...
    public function buildForm(
        ...
        $builder->add('lastName', TextType::class, self::fixedOptions(t('Last Name')));
        $builder->add('middleName', TextType::class, self::fixedOptions(t('Last Name Prepositional Particle')));
        $builder->add('initials', TextType::class, self::fixedOptions(t('Initial(s)')));
        $builder->add('firstName', TextType::class, self::fixedOptions(t('First Name')));
        ...
        $builder->add('expiration', DateType::class, array_merge(
        ...
        $builder->add('supremum', CheckboxType::class, [
        ...
        $builder->add('agreed', CheckboxType::class, [
            'label' => t(
                // phpcs:ignore -- user-visible strings should not be split
        ...
        $builder->add('submit', SubmitType::class, ['label' => t('Renew')]);
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setAllowedTypes('renewal_link', RenewalLink::class);
    }
