...
use App\Form\Member\AuditNoteType;
use App\Form\Member\BulkMemberRenewalType;
use App\Form\Member\DeleteMemberType;
use App\Form\Member\MemberEditType;
use App\Form\Member\MemberListsType;
use App\Service\Member\Member as MemberService;
use App\ViewModel\Member\MemberProfile;
use App\ViewModel\Member\MemberSearchResult;
...
final class MemberController extends AbstractMemberController
{
    ...
    public function delete(
        ...
        if (
            ...
            if (!$form->get('submit_yes')->isClicked()) {
                return $this->redirectToRoute('member_show', ['lidnr' => $lidnr]);
            }
