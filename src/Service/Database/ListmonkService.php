...
class ListmonkService
{
    public function __construct(
        ...
        private readonly ListmonkMailingListRepository $listmonkMailingListRepository,
        private readonly MailingListMemberRepository $mailingListMemberRepository,
        private readonly MemberRepository $memberRepository,
        private readonly Audit $auditService,
        private readonly Config $configService,
        private readonly HttpClientInterface $httpClient,
        #[Autowire(env: 'LISTMONK_API_ENDPOINT')]
        private readonly string $endpoint,
        #[Autowire(env: 'LISTMONK_API_USERNAME')]
        private readonly string $username,
        #[Autowire(env: 'LISTMONK_API_PASSWORD')]
    ...
    public function fetchMailingLists(): void
    {
        ...
        foreach ($lists as $list) {
            $l = $this->listmonkMailingListRepository->find($list['id']);
    ...
    public function getMailingList(int $listmonkId): ?ListmonkMailingList
    {
        return $this->listmonkMailingListRepository->find($listmonkId);
    }
    ...
    {
        if (false === $activeOnly) {
            return $this->listmonkMailingListRepository->findAll();
        }

        return $this->listmonkMailingListRepository->findActive();
    }
    ...
    private function fullCheckListmonkList(
        ...
        $lmList->setLastCheck();
        $this->listmonkMailingListRepository->persist($lmList);
    }
